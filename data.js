(function () {
  ...
  SpanishRPG.DATA = {
    ...
    characters: [
      { id: "explorer", mark: "O", name: "Observant", trait: "Begin with one extra clue." },
      { id: "speaker", mark: "D", name: "Diplomatic", trait: "Begin with two extra coins." },
      { id: "detective", mark: "I", name: "Investigator", trait: "Begin with five extra XP." }
    ],
    intro: [
      "Salamanca, 18:05. You have arrived for a school exchange. Plaza Mayor is crowded, but your teacher, Elena Ruiz, is nowhere to be seen.",
      "Your phone vibrates. An unknown message reads: «Tengo la carpeta azul». The blue folder contains the train tickets for your whole group.",
      "Lucía, a university student, is waiting by the fountain. Walk over to her and find out what she knows."
    ],
    locations: {
      plaza: { name: "Plaza Mayor", subtitle: "Fountain and meeting point", unlocked: true },
      cafe: { name: "Café Niebla", subtitle: "Menu, rumours and a receipt", unlocked: false },
      bookshop: { name: "Librería Atlas", subtitle: "Second-hand books and another clue", unlocked: false }
    },
    dialogue: {
      luciaStart: {
        speaker: "Lucía",
